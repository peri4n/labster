...
import { ContentCopy, ExpandLess, ExpandMore, Info, Search, Timeline } from "@mui/icons-material";
import {
  Box,
  Card,
  CardContent,
...
export function SequenceDetailsPage() {
  ...
  const getAlphabetChip = (type: string) => {
    switch (type.toLowerCase()) {
      case "dna":
        return <Chip label="DNA" color="primary" size="medium" variant="filled" />;
      case "rna":
        return <Chip label="RNA" color="error" size="medium" variant="filled" />;
      case "protein":
        return <Chip label="Protein" color="info" size="medium" variant="filled" />;
      default:
        return <Chip label={type.toUpperCase()} color="default" size="medium" variant="filled" />;
    }
  };
          ...
          <CardContent>
            ...
            >
              ...
              <Box sx={{ flex: 1, display: "flex", alignItems: "center", gap: 1 }}>
                ...
                <Typography variant="body1">{new Date(created_at).toLocaleDateString()}</Typography>
              </Box>
              ...
              <Box sx={{ flex: 1, display: "flex", alignItems: "center", gap: 1 }}>
                ...
                <Typography variant="h6" color="primary.main">
                  ...
                  {alphabet.toLowerCase() === "protein" ? "amino acids" : "nucleotides"}
                </Typography>
              </Box>
            </Box>
