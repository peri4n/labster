...
function renderAplhabetCell(alphabet: string) {
  switch (alphabet) {
    case "dna":
      return <Chip label="DNA" color="primary" variant="outlined" size="small" />;
    case "rna":
      return <Chip label="RNA" color="warning" variant="outlined" size="small" />;
    case "protein":
      return <Chip label="Protein" color="info" variant="outlined" size="small" />;
  }
}
  ...
  return (
    <>
      ...
      <ConfirmationDialog
        ...
        title={"Delete"}
        question={"Are you sure you want to delete the sequence?"}
